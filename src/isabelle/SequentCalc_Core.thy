theory (*calc_name_core-BEGIN*)SequentCalc_Core(*calc_name_core-END*)
...
datatype Formula_Un_Op = Formula_Not ("\<not>\<^sub>F")

datatype Structure_Bin_Op = Structure_Comma (",\<^sub>S")

datatype Structure_Zer_Op = Structure_Empty ("I")
...
datatype Formula = Formula_Atprop Atprop ("_ \<^sub>A" [320] 330)
                 ...
                 | Formula_Un Formula_Un_Op Formula ("U\<^sub>F _ _" [330] 331)

datatype Structure = Structure_Bin Structure Structure_Bin_Op Structure ("B\<^sub>S _ _ _" [340,340,340] 341)
...
(*(*uncommentL?Formula_Un-BEGIN*)*)(*uncommentL?Formula_Un-END*)  | "match_Formula (Formula_Un op1 var1) x = (case x of (Formula_Un op2 var2) \<Rightarrow> (if op1 = op2 then (match var1 var2) else []) | _ \<Rightarrow> [])" (*uncommentR?Formula_Un-BEGIN*)(*(*uncommentR?Formula_Un-END*)*)
...
(*(*uncommentL?Formula_Un-BEGIN*)*)(*uncommentL?Formula_Un-END*)  | "freevars_Formula (Formula_Un  _ var) = freevars var" (*uncommentR?Formula_Un-BEGIN*)(*(*uncommentR?Formula_Un-END*)*)
...
(*(*uncommentL?Formula_Un-BEGIN*)*)(*uncommentL?Formula_Un-END*)  | "replace_Formula_aux x mtch (Formula_Un op1 var) = Formula_Un op1 (replace_Formula_aux x mtch var)" (*uncommentR?Formula_Un-BEGIN*)(*(*uncommentR?Formula_Un-END*)*)
